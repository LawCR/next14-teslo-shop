...
export const initialData: SeedData = {
    users: [
        ...
        },
        {
            ...
            password: bcrypt.hashSync('123456'),
            name: 'Alvaro Empleado',
            // lastName: 'Empleado',
            role: AUTH_CONSTANTS.ROLES.EMPLOYEE
        },
        {
            ...
            name: 'Alvaro Cliente',
            // lastName: 'Cliente',
            role: AUTH_CONSTANTS.ROLES.CLIENT
        },
    ],
    categories: ['Shirts','Pants','Hoodies','Hats', 'Shoes'],
    products: [
        {
        ...
        //     type: 'shirts',
        //     tags: ['shirt'],
        //     title: "Men's Raven Lightweight Zip Up Bomber Jacketasd",
        //     gender: 'men'
        // },
